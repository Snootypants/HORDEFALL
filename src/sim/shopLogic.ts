/**
 * Pure shop purchase logic — credit checks and effect application over the
 * Simulation, no audio/UI. The game layer wraps this with purchase sounds;
 * replay playback applies recorded purchases through it directly.
 */
...
export function applyShopPurchase(sim: Simulation, kind: ShopItemKind): boolean {
